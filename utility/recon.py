...
from sprites_datagen.rewards import ZeroReward, VertPosReward, HorPosReward, AgentXReward, AgentYReward, TargetXReward, TargetYReward, ActualReward
import numpy as np
...
if __name__ == "__main__":
    m=MainModule(num_epoch=60, ww=15, neck = 64)
    m.do(recon_epoch=40)